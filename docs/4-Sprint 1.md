...
O cronograma foi adaptado para 4 dias de aula, que anteriormente seriam 5.
A princípio não será utilizado material em slides, apenas lousa, porém se necessário, usaremos o tinkercad : https://www.tinkercad.com/users/bd2Ti2WDJJd?category=circuits&sort=likes&view_mode=default

A cada aula, iremos nos reunir antes e realizar a montagem do que será usado e escrever a matéria na lousa para não desperdiçar tempo.
